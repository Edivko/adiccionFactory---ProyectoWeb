...
try {
    $__stmtAuth = mysqli_prepare($conexion,
    ...
    if ((int) $__estadoCuenta !== ID_ESTADO_ACTIVA_ADMIN) {
        session_unset();
        session_destroy();
        session_start();
        header('Location: ../public/login.php');
